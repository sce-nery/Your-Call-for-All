 ...
 * Refactored into class structure.
 * @author M. Samil Atesoglu <m.samilatesoglu@gmail.com>
 *
 * Notice:
...
class KdTree {
    ...
    insert(point) {
        ...
        function innerSearch(node, parent) {
            ...
            var dimension = self.dimensions[node.dimension];
        ...
        if (insertPosition === null) {
            self.root = new KdTreeNode(point, 0, null);
            return;
        }

        newNode = new KdTreeNode(point, (insertPosition.dimension + 1) % self.dimensions.length, insertPosition);
    ...
    toJSON(src) {
        ...
        var dest = new KdTreeNode(src.obj, src.dimension, null);
